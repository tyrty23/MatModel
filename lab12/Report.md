...
```markdown
Совокупность долгов описывается кососимметричной матрицей размера \( N \times N \) с нулевой диагональю. 
...
\[ 
X \geq X_0 = \sum_{n=1}^N x_n 
\]

то описываемая этим неравенством ситуация и означает кризис неплатежей (здесь \( x_{nm} \geq 0 \) – индивидуальные свободные средства предприятий). 
