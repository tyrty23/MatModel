...
Практическая задача - определения числа $\pi$ методом Монте-Карло и с помощью задачи Бюффона о бросании иглы.

Модель должна дать колличественный ответ - число $\pi$
...
Вероятность попасть в область внутри окружности равна
